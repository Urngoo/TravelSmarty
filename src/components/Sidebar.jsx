...
const SideBar = () => {
  return (
    <div className="sidebar fixed top-0 left-0 w-64 bg-gray-50 h-screen shadow-md p-6 overflow-y-auto">
      <div className="">
      ...
      <div className="sidebar__menu">
        <ul className="text-black text-lg space-y-3 mt-3">
          <li className="hover:bg-slate-300 rounded-lg">
            ...
            >
              <AppstoreOutlined className="px-2" />
              Dashboard
            </Link>
          </li>
          <li className="hover:bg-slate-300 rounded-lg">
          ...
          <li className="hover:bg-slate-300 rounded-lg">
            <Link
              ...
              className="text-black flex justify-start rounded px-2 py-1"
            >
              <EnvironmentOutlined className="px-2" />
              Map
            </Link>
          </li>
          <li className="hover:bg-slate-300 rounded-lg">
            <Link
              ...
              className="text-black flex justify-start rounded px-2 py-1"
            >
              <CarryOutOutlined className="px-2" />
              Integration
            </Link>
          </li>
        </ul>
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 bg-white rounded-lg shadow-md p-4">
              ...
              <div className="mt-4">
              <Button type="primary" icon={<GoogleOutlined />} className="w-full">
                Go to meet link
              </Button>
              </div>
          </div>
